...
const challengeIcons = [
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 11.5c0 4.7-4 8.5-9 8.5a9.5 9.5 0 0 1-3.2-.55L4 21l1.4-3.9A8.4 8.4 0 0 1 3 11.5C3 6.8 7 3 12 3s9 3.8 9 8.5Z" /><path d="M12 13.6s-2.4-1.4-2.4-3.1a1.65 1.65 0 0 1 2.4-1.5 1.65 1.65 0 0 1 2.4 1.5c0 1.7-2.4 3.1-2.4 3.1Z" /></svg>,
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="8.5" cy="7.5" r="2.7" /><circle cx="16" cy="8.2" r="2.2" /><path d="M3.3 19.2c.5-3.4 2.4-5.4 5.2-5.4s4.7 2 5.2 5.4" /><path d="M14 14.2c2.2.2 3.9 2 4.4 4.9" /></svg>,
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M3.5 11.5 12 4l8.5 7.5" /><path d="M5.5 10v10h13V10" /><path d="M9.5 20v-6h5v6" /></svg>,
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M7 16.5a4.2 4.2 0 0 1-1.3-8.2 4.3 4.3 0 0 1 4.2-3 4.6 4.6 0 0 1 4.3 3 4.2 4.2 0 0 1 3.6 2.2 4 4 0 0 1 .3 4.5 4.3 4.3 0 0 1-3.6 1.9H7Z" /><path d="M9 20c.5-1.5 1.6-2.3 3-2.3s2.5.8 3 2.3" /></svg>,
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="9" cy="6.5" r="2.4" /><path d="M4.4 18.3c.5-3.3 2.2-5.2 4.6-5.2s4.1 1.9 4.6 5.2" /><circle cx="17.5" cy="10.5" r="1.7" /><path d="M14.7 18.3c.34-2.2 1.5-3.5 3-3.5s2.66 1.3 3 3.5" /></svg>,
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M6 21V4" /><path d="M6 5h12l-2.5 3L18 11H6" /></svg>,
];
...
export default function FamilyTherapyPage() {
  return <main className="family-page">
    ...
    <section id="approach" className="family-section"><div className="family-container family-container-wide family-approach"><img className="reveal reveal-from-left" src="/happy-family-with-dog-moving-new-home-100kb.jpg" alt="A peaceful, welcoming space" /><div className="family-approach-copy reveal reveal-from-right"><p className="family-kicker">COUNSELING FOR FAMILY ISSUES</p><h2 className="family-title">Support That Brings Your Family Closer</h2><p><strong>Sometimes the hardest part is not knowing how to talk to the people you love most.</strong></p><p>At Open Arms Initiative, our Family Therapy in Oklahoma City gives families a supportive place to slow down, understand what is happening beneath the conflict, and begin rebuilding connection.</p><p>Together, we can work toward:</p><ul>{['Stronger communication','Healing past hurts','Greater trust and connection','Healthier boundaries','More constructive conflict resolution','A calmer, more supportive home'].map(x => <li key={x}>{x}</li>)}</ul><p>Family counseling is not about deciding who is right or wrong. It is about helping your family understand one another and find a healthier way forward.</p></div></div></section>
