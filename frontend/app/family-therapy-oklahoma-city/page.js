...
const trustIcons = [
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 20.2s-7.6-4.4-7.6-10a4.4 4.4 0 0 1 7.6-3 4.4 4.4 0 0 1 7.6 3c0 5.6-7.6 10-7.6 10Z" strokeLinejoin="round" /></svg>,
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M12 3.5 5 6v5.5c0 4.6 3 8 7 9 4-1 7-4.4 7-9V6l-7-2.5Z" strokeLinejoin="round" /><path d="m9 12 2 2 4-4.2" strokeLinecap="round" strokeLinejoin="round" /></svg>,
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><circle cx="12" cy="8.3" r="3.6" /><path d="m8.7 11.2-2 8.3 5.3-2.5 5.3 2.5-2-8.3" strokeLinejoin="round" /></svg>,
  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5"><rect x="3" y="6" width="12" height="12" rx="2" /><path d="m15 10 6-3v10l-6-3" strokeLinejoin="round" /></svg>,
];
...
export default function FamilyTherapyPage() {
  return <main className="family-page">
    <section className="family-hero-outer"><div className="family-hero-bg"><img className="family-hero-img-desktop" src="/family.jpg" alt="Family spending time together outdoors" /><img className="family-hero-img-mobile" src="/fam9.jpg" alt="Family spending time together outdoors" /><div className="family-hero-content">
      ...
      <div className="family-trust">{['Compassionate Care','Safe & Confidential','Experienced Therapists','In-Person & Online Sessions'].map((item, i) => <div key={item}><span>{trustIcons[i]}</span>{item}</div>)}</div>
