...
export default function FosterCarePage() { return <main className="grief-page">
  ...
  <section className="grief-hero-outer"><div className="grief-hero-bg"><img src="/fam9.jpg" alt="Foster family spending time together outdoors in Oklahoma City" /><div className="grief-container grief-hero-content"><p className="grief-kicker">SUPPORT FOR THE JOURNEY. CARE FOR THE WHOLE FAMILY.</p><h1>Foster Care Support<br />in Oklahoma City</h1><i /><p className="grief-lead">Opening Your Home Takes Heart. You Don&rsquo;t Have to Navigate Everything That Comes Next Alone.</p><p>Foster care can bring moments of connection, growth, uncertainty, joy, and challenge&mdash;sometimes all at once.</p><p>You may be trying to understand a child&apos;s behavior while helping them feel safe. You may be navigating new routines, appointments, transitions, relationships, or questions you never expected to face.</p><p>At Open Arms Initiative, we support foster and adoptive families with compassionate guidance, training, counseling, and ongoing support designed to help children and caregivers move forward together.</p><div className="grief-actions"><Link href="/contact" className="grief-btn grief-solid">Connect With Foster Care Support</Link><Link href="/services" className="grief-btn grief-outline">Explore Our Services</Link></div></div></div></section>
  ...
  <section className="grief-statement"><div className="grief-container reveal reveal-scale-in"><div><h2>&ldquo;A child doesn&rsquo;t need you to have every answer. They need to know they are not facing everything alone&mdash;and neither are you.&rdquo;</h2><Link href="/contact" className="grief-btn grief-light">Connect With Open Arms</Link></div><img src="/n1.jpg" alt="Hands offering comfort and support to a foster family member" /><aside>Foster parenting can ask a lot of your heart.<br /><br />There will be things you can prepare for.<br /><br />And there may be things no training could completely prepare you for.<br /><br />Support is here for those moments too.</aside></div></section>

  <section className="grief-section"><div className="grief-container"><div className="grief-more grief-more-reverse"><div className="reveal reveal-from-left"><p className="grief-kicker-label">SUPPORT FOR FOSTER PARENTS &amp; CAREGIVERS</p><h2>You&rsquo;re Supporting the Child. We&rsquo;re Here to Support You.</h2><p>Open Arms currently states that it provides foster families with training and ongoing guidance, including round-the-clock support for foster parents.</p><p>Support can help caregivers better understand:</p><ul>{supportKindsList.map(x => <li key={x}>{x}</li>)}</ul><p><strong>Caregivers need somewhere to ask questions too.</strong></p></div><img className="reveal reveal-from-right" src="/family4.jpg" alt="Two people offering each other comfort and support" /></div></div></section>

  <section className="grief-section grief-heavy"><div className="grief-container reveal reveal-from-bottom"><h2>Counseling for Children in Foster Care</h2><p>Children in foster care may be navigating experiences and emotions that are difficult to put into words.</p><p>Open Arms currently provides <Link href="/services/foster-care-adoption-counseling">Foster Care &amp; Adoption Counseling</Link> and describes its approach as collaborative, involving children, parents, and the wider community where appropriate.</p><p>Counseling can provide a supportive environment for children to explore emotions, experiences, relationships, transitions, and concerns at an appropriate pace.</p><p>When relevant, families can also explore our <Link href="/child-counseling-services-oklahoma-city/">Child &amp; Adolescent Counseling</Link> services.</p></div></section>

  <section className="grief-section grief-heavy"><div className="grief-container reveal reveal-from-bottom"><h2>Support for Adoptive Families</h2><p>Adoption can be deeply meaningful while still bringing questions and adjustments.</p><p>Children and parents may be navigating identity, attachment, family relationships, past experiences, expectations, or major transitions.</p><p>Open Arms&rsquo; existing program specifically supports both foster and adoptive families, so adoption remains part of this page rather than being treated as an unrelated service.</p><p><strong>Support isn&apos;t about suggesting something is wrong with your family. It&apos;s about recognizing that every family&apos;s story is different&mdash;and sometimes having professional support can make that journey feel less isolating.</strong></p></div></section>
