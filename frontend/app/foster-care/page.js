...
export default function FosterCarePage() { return <main className="grief-page">
  ...
  <section className="grief-statement"><div className="grief-container reveal reveal-scale-in"><div><h2>&ldquo;A child doesn&rsquo;t need you to have every answer. They need to know they are not facing everything alone, and neither are you.&rdquo;</h2><Link href="/contact" className="grief-btn grief-light">Connect With Open Arms</Link></div><img src="/n1.jpg" alt="Hands offering comfort and support to a foster family member" /><aside>Foster parenting can ask a lot of your heart.<br /><br />There will be things you can prepare for.<br /><br />And there may be things no training could completely prepare you for.<br /><br />Support is here for those moments too.</aside></div></section>
