...
export default function FosterCareRequestForm() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const params = new URLSearchParams({ service: 'foster-care', ...form }).toString();
  ...
  return (
    <form className="marriage-req-form" onSubmit={handleSubmit}>
      ...
      <label className="marriage-req-label">Tell us a bit about your family&rsquo;s needs</label>
      ...
      <button type="submit" className="marriage-btn marriage-req-btn-primary marriage-req-submit">
        <IconSend />
        Request Appointment
      </button>
