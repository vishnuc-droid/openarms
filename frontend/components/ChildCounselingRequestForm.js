...
export default function ChildCounselingRequestForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    setError('');
    try {
      await submitForm({ service: 'child-counseling', ...form });
  ...
  return (
    <form className="ca-req-form" onSubmit={handleSubmit}>
      ...
      <label className="ca-req-label">How will you be paying for services?</label>
      <div className="ca-req-input-wrap">
        <IconShield />
      ...
      <label className="ca-req-label">Message / How can we help?</label>
