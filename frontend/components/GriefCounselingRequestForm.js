...
export default function GriefCounselingRequestForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    setError('');
    try {
      const { id } = await submitForm({ service: 'grief-counseling', topic: 'Grief & Loss Counseling', ...form });
  ...
  return (
    <form className="grief-req-form" onSubmit={handleSubmit}>
      ...
      <label className="grief-req-label">How will you be paying for services?</label>
      <div className="grief-req-input-wrap">
        <IconShield />
      ...
      <label className="grief-req-label">Message / How can we help?</label>
