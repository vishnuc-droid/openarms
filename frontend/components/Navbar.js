...
export default function Navbar() {
  ...
  const isDonatePage = pathname === '/donate-to-support-counseling-education-emotional-healing';

  return (
    <header
      ref={headerRef}
      className={`reference-header home-hero-header${isDonatePage ? ' home-hero-header--solid' : ''}`}
    ...
    >
      <div className="top-nav">
        ...
        <nav className={menuOpen ? 'mobile-accordion-nav open' : 'mobile-accordion-nav'}>
          ...
          <Link href="/donate-to-support-counseling-education-emotional-healing" className="mobile-nav-link" onClick={closeMobileNav}>Donate</Link>
        </nav>
        ...
        <Link className="reference-cta-donate-small" href="/donate-to-support-counseling-education-emotional-healing" aria-label="Donate">
          Donate
        </Link>
      </div>
